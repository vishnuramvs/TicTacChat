...
public class VladTicTacToe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Vlad's Tic Tac Toe Board");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 263, Short.MAX_VALUE)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(ties, javax.swing.GroupLayout.DEFAULT_SIZE, 23, Short.MAX_VALUE))
                            .addGroup(layout.createSequentialGroup()
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (!TcpMethods.send("vlad:NEWGAMEREQ", 9876)) {
    ...
    private void makeMove(javax.swing.JButton btn, int x, int y) {
        if (btn.getText().equalsIgnoreCase(" ") && myTurn == true) {
            ...
            TcpMethods.send("vlad:PIECE:"+x+","+y+","+Character.toString(myPiece),9876);
            board.insertIntoBoard(myPiece, x, y);
            enableBoard(false);
            setMyTurn(false);
            setLabel2Text("Josh's Turn");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VladTicTacToe().setVisible(true);
            }
        });
    }
